  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] pt-24 pb-12 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl text-center">
        <p className="text-sm font-semibold text-rose-600" data-animate="text" data-animate-variant="slide-down">404</p>
        <h1 className="mt-3 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl" data-animate="text" data-animate-variant="slide-up">
          Page not found
        </h1>
        <p className="mt-4 text-base text-slate-600" data-animate="text" data-animate-variant="fade">
