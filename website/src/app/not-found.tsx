    ...
    <div className="min-h-screen bg-[#FAFAFA] pt-24 pb-12 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
          <Link href="/">
            <Button className="h-11 px-6">Back to home</Button>
          </Link>
          <Link href="/tutorial">
            <Button variant="outline" className="h-11 px-6">View tutorial</Button>
          </Link>
          <Link href="https://github.com/Microck/tuneport" target="_blank">
            <Button variant="ghost" className="h-11 px-6">Open Source on GitHub</Button>
          </Link>
        </div>
      </div>
    </div>
