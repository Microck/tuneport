    ...
    <div className="relative bg-white pb-24 pt-24 overflow-hidden">
      ...
      <div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative mb-16">
          <NeonGradientCard className="items-start text-left bg-white">
        ...
        <div className="mb-24">
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <MagicCard className="relative overflow-hidden rounded-xl border border-slate-200 p-6 shadow-sm" gradientColor={"#F1F5F9"}>
